...
public class BeanValidator implements Validator {
	 ...
	 */
	public BeanValidator(ValidatorFactory validatorFactory, Class<?> beanClass, String propertyName) {
	...
	public void validate(final Object value) throws InvalidValueException {
		...
		if (violations.size() > 0) {
			...
			for (Object v : violations) {
				...
				String msg = validatorFactory.getMessageInterpolator().interpolate(violation.getMessageTemplate(),
						new SimpleContext(value, violation.getConstraintDescriptor()), locale);
